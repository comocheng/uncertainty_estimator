...
np.save('distance_array.npy', dist_array)

np.save('T_array.npy', T_array)

data0 = np.load('/home/moon/uncertainty_estimator/nam29_abstract/cpox_pt/results/gas_spec_0000_gas_out.npy')
data3 = np.load('/home/moon/uncertainty_estimator/nam29_abstract/cpox_pt/results/gas_spec_0003_gas_out.npy')
